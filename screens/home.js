        ...
        return(
            <View style={{flexDirection:'row' ,height:50}}>
                ...
                <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
                    <View
                        style={{width:'70%',height:'100%',backgroundColor:COLORS.lightGray3,
                                alignItems:'center' , justifyContent :'center' , borderRadius:SIZES.radius}}
                    >
                        <Text styles={{...FONTS.h3}}>{currentLocation.streetName}</Text>
                    </View>
                </View>
    ...
    function renderMainCategories(){
        const renderItem =({item})=> {
            return (
                ...
                >
                <View style={{width:50,height:50,borderRadius:25,alignItems:'center',
